...
let allItems = {
    ...
    "emberleaf liquor": new Item("emberleaf liquor", "mmhmm... spicy", "potion", 80, asCanvas(vial, ["#000000ff", "#794129ff", "#a16a48ff", "#546a77ff", "#6d858fff", "#a8aba6ff",  "#682072ff", "#a534b4ff", "#8c3397ff"]).toDataURL(), "#682072ff"),
};
